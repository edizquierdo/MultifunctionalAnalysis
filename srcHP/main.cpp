...
const double BIASRANGE = BIASMAX;
...
double PerceiveAffordance(TVector<double> &v, RandomState &rs)
{
	...
	VisualAgent Agent(0.0,0.0,NUMRAYS,NUMINTER,NUMMOTOR,WINDOWSIZE,BOUNDARY,BIASTIMECONSTANT,WEIGHTTIMECONSTANT,WEIGHTRANGE,BIASRANGE);
