...
class VisualAgent {
	public:
		// The constructor
		VisualAgent(double ix = 0.0, double iy = 0.0, int NumRays_ = 7, int NumInterNeurons_ = 5, int NumMotors_ = 2, double WS = 1, double B = 0, double BT = 1.0, double WT = 1.0, double WR = 10.0, double BR = 100.0) {
			NumRays = NumRays_;
			...
			NervousSystem.SetCircuitSize(NumNeurons,WS,B,BT,WT,WR,BR);
		};
